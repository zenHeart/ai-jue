...
| [RFC-0002: Plugin / Bundle Artifact apply contract](0002-plugin-artifact-apply.md) | Implementing | Config-first + CLI override; OpenClaw `compatible-bundle` delegates to Claude/Codex plugins; Hermes workspace-first with optional thin `skill-plugin` |
