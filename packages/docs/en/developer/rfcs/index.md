...
| [RFC-0002: Plugin / Bundle Artifact apply contract](0002-plugin-artifact-apply.md) | Implementing | CLI/`targets` and four-agent plugin paths wired; OpenClaw `compatible-bundle` delegates to Claude/Codex; Hermes thin `skill-plugin` landed; Epic tracking close-out |
