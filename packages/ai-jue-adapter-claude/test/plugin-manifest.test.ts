...
describe("write() with a Plugin manifest", () => {
  ...
  it("writes a manifest that passes real `claude plugin validate --strict`", async () => {
    const root = tempDir();
    ...
    // Real native confirmation, not just a unit-test assertion: the agent's
    // own validator must accept what write() produced.
