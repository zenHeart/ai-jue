...
export async function write(
  ...
  if (artifactKind === "plugin") {
    ...
    if (
      ...
      throw new Error(
        `Codex Plugin manifest at ${path.join(writeContext.projectRoot, ".codex-plugin", "plugin.json")} must contain non-empty name and version fields.`,
      );
    }
    manifest = {
      ...candidate,
    ...
    changes.push(
      ...writeCodexPluginManifest(writeContext.projectRoot, manifest, TARGET),
    );
  }
